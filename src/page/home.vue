<template>
    <div>
		...
		<section class="data_section">
			<header class="section_title">锦富集团-编码管理系统</header>
		<!--	<el-row :gutter="20" style="margin-bottom: 10px;">
            ...
            <div>
                <p>1.客户、供应商编码：</p>
                <p>长度6位：分类码（1）+缩写码（4）+保留码（1）</p>
                <p>分类码：1位，“A”代表客户，“C”代表供应商</p>
                <p>缩写码：4位，自行定义，任意数字或字母，不得重复</p>
                <p>保留码：1位，由相关代码编制部门自行定义使用，默认0</p>
            </div>
		</section>
